                        ...
                        <div class="widget-item mt-40">
                            ...
                            <div class="widget-body">
                                <ul class="location-wrap">
                                    ...
                                    <li><i class="ion-ios-telephone-outline"></i>Phone: <a href="/-0025425456554.html">+ 00 254 254565</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-md-6 order-2 order-md-1">
                        <div class="copyright-text text-center text-md-start">
                            <p>&copy; <?= date("Y") ?> <b>NAMINC</b> Made with <i class="fa fa-heart text-danger"></i> by <a href="https://naminc.io"><b>naminc.io</b></a></p>
                        </div>
                    </div>
